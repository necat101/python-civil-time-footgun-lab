...
def main():
    ...
    out.append("Expected vs actual observation fields (local_preserved, utc_derived, gap_detected, fold_detected, recurrence_ok, all_day_ok, display_preserved, grouping_differs, zone_valid, abbrev_caveat, external_truth_not_tested) ")
